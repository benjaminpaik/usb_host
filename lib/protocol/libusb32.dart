...
base class libusb_device_descriptor extends ffi.Struct {
...
/// All multiple-byte fields are represented in host-endian format.
base class libusb_endpoint_descriptor extends ffi.Struct {
  /// Size of this descriptor (in bytes)
  @ffi.Uint8()
  external int bLength;
...
/// All multiple-byte fields are represented in host-endian format.
base class libusb_interface_descriptor extends ffi.Struct {
  /// Size of this descriptor (in bytes)
  @ffi.Uint8()
  external int bLength;
...
base class libusb_interface extends ffi.Struct {
...
/// All multiple-byte fields are represented in host-endian format.
base class libusb_config_descriptor extends ffi.Struct {
  /// Size of this descriptor (in bytes)
  @ffi.Uint8()
  external int bLength;
...
/// host-endian format.
base class libusb_ss_endpoint_companion_descriptor extends ffi.Struct {
  /// Size of this descriptor (in bytes)
  @ffi.Uint8()
  external int bLength;
...
base class libusb_bos_dev_capability_descriptor extends ffi.Opaque {}

/// \ingroup libusb_desc
/// A structure representing the Binary Device Object Store (BOS) descriptor.
/// This descriptor is documented in section 9.6.2 of the USB 3.0 specification.
/// All multiple-byte fields are represented in host-endian format.
base class libusb_bos_descriptor extends ffi.Opaque {}

/// \ingroup libusb_desc
/// A structure representing the USB 2.0 Extension descriptor
/// This descriptor is documented in section 9.6.2.1 of the USB 3.0 specification.
/// All multiple-byte fields are represented in host-endian format.
base class libusb_usb_2_0_extension_descriptor extends ffi.Struct {
  /// Size of this descriptor (in bytes)
  @ffi.Uint8()
  external int bLength;
...
/// All multiple-byte fields are represented in host-endian format.
base class libusb_ss_usb_device_capability_descriptor extends ffi.Struct {
  /// Size of this descriptor (in bytes)
  @ffi.Uint8()
  external int bLength;
...
base class libusb_container_id_descriptor extends ffi.Struct {
  /// Size of this descriptor (in bytes)
  @ffi.Uint8()
  external int bLength;
...
base class libusb_control_setup extends ffi.Struct {
...
base class libusb_context extends ffi.Opaque {}

base class libusb_device extends ffi.Opaque {}

base class libusb_device_handle extends ffi.Opaque {}

/// \ingroup libusb_lib
/// Structure providing the version of the libusb runtime
base class libusb_version extends ffi.Struct {
...
base class libusb_iso_packet_descriptor extends ffi.Struct {
...
/// it back to the user.
base class libusb_transfer extends ffi.Opaque {}
...
base class libusb_pollfd extends ffi.Struct {
