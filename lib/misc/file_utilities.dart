...
String generateHeaderFile(ConfigData configData) {
  ...
  inputText += "// number of parameters$newline";
  inputText +=
      "#define PARAMETER_ARRAY_SIZE ${configData.parameter.length}$newline$newline";
  inputText +=
      "// definitions associating parameters with their names in the host file$newline";
  inputText += "typedef union {$newline";
  inputText += "  long a[PARAMETER_ARRAY_SIZE];$newline";
  inputText += "  struct {$newline";
  ...
  inputText += "#endif /* PARAMETER_H_ */$newline";
